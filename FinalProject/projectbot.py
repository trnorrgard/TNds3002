...
load_dotenv()
TOKEN = os.getenv('OTcxODA4MDgzMTQxNjA3NTI0.YnP4zg.vA4oazIwd4lWR_XG_fVJYli1rmA')
GUILD = os.getenv('DS 3002 Project')
...
client.run('OTcxODA4MDgzMTQxNjA3NTI0.YnP4zg.vA4oazIwd4lWR_XG_fVJYli1rmA')
